...
<div class="main-container">
	...
	// Ttitre de la section blog hors ul
	echo '<h2 id="leblog" class="chic-title">Nos marques de luxe</h2>';
    ...
    <a href="<?php echo esc_url( get_permalink() ); ?>" aria-label="lien vers l'article"></a>
